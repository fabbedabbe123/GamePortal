...
## Titlar (hederstitlar bredvid användarnamn)

Ny flik i adminpanelen: **🏷 Titlar**. Skriv in ett exakt användarnamn och
en titel (t.ex. "👑 Turneringsvinnare" eller "VIP"), klicka **Sätt titel**.

Titeln visas sen:
- Bredvid personens namn i profil-hörnan (nere till vänster)
- Under namnet högst upp i deras profil (när du eller andra öppnar den)

Lämna titelfältet tomt och klicka Sätt titel igen för att ta bort en
persons titel. Kräver Worker-koden uppdaterad igen (ny `/users/title`-
endpoint) och samma Admin-nyckel som Feedback/Topplista-nollställning
använder.
