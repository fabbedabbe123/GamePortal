(function () {
  ...
  const STRINGS = {
    ...
    tabManageGames: { sv: "✏️ Hantera spel", en: "✏️ Manage games" },
    manageGamesHint: { sv: "Redigera ett befintligt spels titel/beskrivning/färg, eller stäng av åtkomst tillfälligt (t.ex. medan du uppdaterar spelfilen).", en: "Edit an existing game's title/description/color, or temporarily disable access (e.g. while updating the game file)." },
    labelMgGame: { sv: "Spel", en: "Game" },
    labelMgTitle: { sv: "Titel", en: "Title" },
    labelMgCategory: { sv: "Kategori", en: "Category" },
    labelMgDescSv: { sv: "Beskrivning (svenska)", en: "Description (Swedish)" },
    labelMgDescEn: { sv: "Description (engelska)", en: "Description (English)" },
    labelMgColor: { sv: "Accentfärg", en: "Accent color" },
    labelMgDisabled: { sv: "Inaktiverad (dold för besökare)", en: "Disabled (hidden from visitors)" },
    mgSaveBtn: { sv: "Spara ändringar", en: "Save changes" },
    tabTitles: { sv: "🏷 Titlar", en: "🏷 Titles" },
    titlesHint: { sv: 'Kräver Admin-nyckel. Ge en spelare en titel som syns bredvid deras namn i profilen — t.ex. "👑 Turneringsvinnare" eller "VIP". Lämna tomt och spara för att ta bort en titel.', en: 'Requires the Admin key. Give a player a title that shows next to their name in their profile — e.g. "👑 Tournament Winner" or "VIP". Leave blank and save to remove a title.' },
    labelTitleUsername: { sv: "Användarnamn", en: "Username" },
    labelTitleText: { sv: "Titel", en: "Title" },
    titleSaveBtn: { sv: "Sätt titel", en: "Set title" }
  };
  ...
  function applyLanguage() {
    ...
    setText("tab-btn-managegames", "tabManageGames");
    setText("managegames-hint", "manageGamesHint");
    setText("label-mg-game", "labelMgGame");
    setText("label-mg-title", "labelMgTitle");
    setText("label-mg-category", "labelMgCategory");
    setText("label-mg-desc-sv", "labelMgDescSv");
    setText("label-mg-desc-en", "labelMgDescEn");
    setText("label-mg-color", "labelMgColor");
    setText("label-mg-disabled", "labelMgDisabled");
    setText("mg-save-btn", "mgSaveBtn");
    setText("tab-btn-titles", "tabTitles");
    setText("titles-hint", "titlesHint");
    setText("label-title-username", "labelTitleUsername");
    setText("label-title-text", "labelTitleText");
    setText("title-save-btn", "titleSaveBtn");
