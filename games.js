...
const GAMES = [
  ...
  },
  {
    ...
    category: "Strategy",
    description: "8 unique towers, 10 enemy types, mergeable Mega towers, 3 maps, and a permanent skill tree. Endless waves — how far will you get?",
    descriptionEn: "8 unique towers, 10 enemy types, mergeable Mega towers, 3 maps, and a permanent skill tree. Endless waves — how far will you get?",
    color: "#e8b84b",
    cart: "10",
    addedAt: "2026-07-16",
    scoreKey: "towerDefenseBestWave",
    scoreLabel: "Wave",
    scoreLabelEn: "Wave",
    scoreBetter: "higher",
    thumb: `
      <svg viewBox="0 0 320 200" xmlns="http://www.w3.org/2000/svg">
        <rect width="320" height="200" fill="#16321f"/>
        <path d="M -10 40 L 220 40 L 220 100 L 80 100 L 80 160 L 300 160" fill="none" stroke="#3a2e1f" stroke-width="26" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M -10 40 L 220 40 L 220 100 L 80 100 L 80 160 L 300 160" fill="none" stroke="#4a3826" stroke-width="18" stroke-linecap="round" stroke-linejoin="round"/>
        <circle cx="150" cy="40" r="12" fill="#4fc9c0" stroke="#0b0b0b" stroke-width="2"/>
        <circle cx="80" cy="130" r="12" fill="#e8b84b" stroke="#0b0b0b" stroke-width="2"/>
        <circle cx="230" cy="160" r="12" fill="#c084fc" stroke="#0b0b0b" stroke-width="2"/>
        <circle cx="260" cy="70" r="9" fill="#ff6b7a"/>
        <circle cx="190" cy="100" r="7" fill="#ffd166"/>
      </svg>
    `
  }
];
